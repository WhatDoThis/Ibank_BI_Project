 ...
 * App.jsx (메인 앱 컴포넌트)
 * ===========================
 * Phase 4: 레이아웃 + 그리드·필터·SQL·실행·페이지네이션 상태 및 로드.
 *
 * [주요 기능]
 * - 데이터 로드: health, list-tables, describe-table, table-relationships
 ...
 *
 * [의존성]
 * - React, api/client, utils/sqlBuilder, components/Header, Sidebar, MainArea
 */

import { useState, useEffect, useCallback } from 'react'
import { health, listTables, describeTable, tableRelationships as fetchTableRelationships, executeQuery as apiExecuteQuery, explainSql } from './api/client'
