 ...
 * ==========================================================
 * 테이블 선택 + 기간 + 조회, 집계 기준, 정렬 기준, 캠페인·워크플로우·채널 필터. 집계 체크 해제 시 해당 셀렉트 비활성화.
 *
 * [주요 기능]
 * - 1행: 테이블 셀렉트 + info(필수 컬럼 안내) + 기간 + 조회
 * - 2행: 집계 기준 체크박스 (캠페인별·일자별·워크플로우별·채널별), 정렬 기준 버튼 (일자·발송수·성공수·오픈수·클릭수)
 * - 3행: 캠페인·워크플로우·채널 멀티 셀렉트
 *
 * [의존성]
 * - React, @/shared/api/client (getDashboardRequiredColumns), @/shared/utils/dateRange (normalizeDateRange)
 */
