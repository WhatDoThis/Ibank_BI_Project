/**
 * dashboard/components/DashboardHeader.jsx (대시보드1 헤더)
 * ==========================================================
 ...
 * [Dependencies]
 * =========
 * - React, @/packages/dashboard/api/dashboardClient.js (getDashboardRequiredColumns), dashboard/utils/dateRange (normalizeDateRange), dashboard/utils/periodCompare
 */

import { useState, useEffect } from 'react'
import { getDashboardRequiredColumns } from '@/packages/dashboard/api/dashboardClient.js'
    ...
    <header className="dashboard-header">
      ...
      <div className="dashboard-header__table-row">
        ...
        <div className="dashboard-header__date-cell">
          <span className="dashboard-header__view-mode-label">보기</span>
          <div className="dashboard-header__view-mode">
            <label className="dashboard-header__view-mode-radio">
              <input
                type="radio"
                name="view_mode"
        ...
        <div className="dashboard-header__date-cell">
          <label className="dashboard-header__date-label">
        ...
        {view_mode === 'week_compare' && (
          <div className="dashboard-header__date-cell">
            <label className="dashboard-header__date-label" title="비어두면 전 주가 비교 기간으로 사용됩니다">비교 주(날짜)</label>
            <div className="dashboard-header__date-inputs">
              <input
                type="date"
                className="dashboard-header__date-input"
        ...
        {view_mode === 'month_compare' && (
          <div className="dashboard-header__date-cell">
            <label className="dashboard-header__date-label" title="비어두면 전 월이 비교 기간으로 사용됩니다">비교 월</label>
            <div className="dashboard-header__date-inputs">
              <input
                type="month"
                className="dashboard-header__date-input"
        ...
        {view_mode === 'day_compare' && (
          <div className="dashboard-header__date-cell">
            <label className="dashboard-header__date-label" title="비어두면 전 일이 비교 기간으로 사용됩니다">비교 일</label>
            <div className="dashboard-header__date-inputs">
              <input
                type="date"
                className="dashboard-header__date-input"
        ...
        {view_mode === 'year_compare' && (
          <div className="dashboard-header__date-cell">
            <label className="dashboard-header__date-label" title="비어두면 전 연도가 비교 기간으로 사용됩니다">비교 연도</label>
            <div className="dashboard-header__date-inputs">
              <input
                type="number"
                className="dashboard-header__date-input"
