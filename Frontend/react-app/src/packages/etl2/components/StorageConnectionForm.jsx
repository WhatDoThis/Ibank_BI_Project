/**
 * packages/etl2/components/StorageConnectionForm.jsx (저장 DB 등록 폼)
 * ======================================================================
 * ETL2 Phase 1: 적재 대상 DB(PostgreSQL) 등록. 연결 테스트(접속+CREATE/INSERT/DROP 권한) 후 등록.
 * UI: etl-db-form 스타일 재사용. 목록·삭제.
 *
 * [Main Functions]
 * ===========
 * - 저장 DB 목록 조회, 연결 테스트, 등록, 삭제
 * - onSuccess: 등록/삭제 성공 시 콜백
 *
 * [Dependencies]
 * =========
