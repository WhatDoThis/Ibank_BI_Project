 ...
 * [Main Functions]
 * ===========
 * - open + folderConnectionId 시 batchListFolderPatterns 호출, 로딩/에러 처리
 * - 테이블: 패턴, 파일 수, 최신 TS, 최고 TS, 확장자 컬럼, 행별 [선택] 버튼
 * - 직접 입력: input + [선택] → onSelect(trim값) 후 onClose
 *
 * [Props]
 * =====
 * - open: boolean
 * - onClose: () => void
 * - folderConnectionId: number | null
