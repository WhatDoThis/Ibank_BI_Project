 ...
 * [Main Functions]
 * ===========
 * 1. batchListJobHistory(batchJobId) 마운트 시 호출, runs 테이블 표시
 * 2. 테이블: run_id, started_at, finished_at, status(일부만 실패 시 "일부 실패 (N/M 성공)"), files_processed, rows_inserted, rows_updated, error_message, [상세]
 *
 * [Props]
 * =====
 * 1. batchJobId: number — 배치 Job ID
 * 2. onClose: () => void — 모달 닫기
 * 3. onSelectRun: (runId: number) => void — (optional) [상세] 클릭 시 호출, 상위에서 상세 뷰 표시
 *
 * [Dependencies]
 * =========
