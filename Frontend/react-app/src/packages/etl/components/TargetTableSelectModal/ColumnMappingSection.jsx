 ...
 * [Main Functions]
 * ===========
 * 1. ColumnMappingSection: hasSourceMapping, sourceColumns, selectedTable, displaySourcesForNewTable, newTableTargetNames, newTableExcluded, setNewTableTargetNames, setNewTableExcludedFor, ... (매핑/변환/PK/인덱스 관련 props)
 * 2. CustomIndexSection: 소스 인덱스 없을 때 인덱스 추가 UI
 *
 * [Dependencies]
 * =========
 * - React
