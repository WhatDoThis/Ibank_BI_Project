 ...
 * [Main Functions]
 * ===========
 * 1. normalizeStorageConnectionId(uiValue) → null | number. 폼/셀렉트 값 → API·body용. ''/null/undefined → null, 그 외 Number.
 * 2. getStorageConnectionIdForFormData(uiValue) → null | number. FormData에 넣을 때만 사용; null이면 append 안 함.
 */
