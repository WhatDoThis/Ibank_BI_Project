 ...
 * [Components]
 * ===========
 * 1. getDistributionTotal: 기준/비교 데이터 유무 판별
 * 2. DonutBlock: variant(default|base|compare). default=CHART_COLORS_PALETTE, base=연한색, compare=짙은색
 * 3. ChannelDonutCharts2 (default export): kpi, compareKpi. 기준 블록(--base), 비교 블록(--compare)
 *
 * [Dependencies]
 * =========
