"""
I1_ 파생 테이블 15개 생성.
원천: campaigns, test_deliveries_data, test_delivery_tracking, workflows
...
def main():
    ...
    """, "I1_delivery_tracking_joined")
        ...
        run_sql(conn, f"""
        CREATE TABLE {tbl("I1_daily_delivery_count")} AS
    ...
    """, "I1_campaign_delivery_count")
        ...
        run_sql(conn, f"""
        CREATE TABLE {tbl("I1_workflow_delivery_count")} AS
    ...
    """, "I1_campaign_daily_channel")
        ...
        run_sql(conn, f"""
        CREATE TABLE {tbl("I1_delivery_status_summary")} AS
    ...
    """, "I1_workflow_list_per_campaign")
        ...
        run_sql(conn, f"""
        CREATE TABLE {tbl("I1_recent_deliveries")} AS
