...
[Main Functions]
===========
1. list_roles_for_dept(생성자 FK user_info JOIN·creator_email·create_dtm·update_dtm·집계 MAX·목록 기본 정렬 update_dtm DESC)
    ...
    try:
        cur.execute(
            ...
            GROUP BY
                ...
                pm.update_dtm,
                pm.user_id
            ORDER BY pm.update_dtm DESC NULLS LAST, pm.system_dflt_yn DESC, pm.pmssn_name ASC
            """,
            (dptmt_info_id,),
        )
