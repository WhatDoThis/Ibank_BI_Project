"""
Backend.etl_server.folder_adapter_file (원격 폴더 어댑터)
==========================================================
...
[Main Classes]
===========
1. FolderAdapter: 추상 인터페이스 (test_connection, list_files, download_file, delete_file, close)
2. SFTPAdapter: paramiko 기반 SFTP
3. S3Adapter: boto3 기반 S3
