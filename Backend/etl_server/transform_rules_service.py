...
==============================================================
etl_transform_rules 테이블 조회·등록·수정·삭제. Phase 4 변환(T) 1차.
...
- update_transform_rule: 룰 수정
- delete_transform_rule: 룰 삭제

[Dependencies]
=========
- Backend.etl_server.service (_get_db, _schema, _q, _validate_identifier)
"""
