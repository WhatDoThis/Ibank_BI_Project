"""
Backend.etl_server.timezone_utils (ETL 시간대 변환 유틸리티)
============================================================
ETL 시간대 변환 유틸리티.
...
[Main Functions]
===========
1. _is_temporal_type: DB data_type이 날짜/시간 관련인지 판별
2. needs_conversion: 변환 필요 여부 (source_tz, target_tz)
3. convert_timezone_columns: DataFrame의 시간 컬럼 일괄 변환
4. convert_single_datetime: 단일 datetime 변환 (last_synced_at용)
