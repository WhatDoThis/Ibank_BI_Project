"""
Backend.api_server.analysis_store
=================================
allowlist_analysis 테이블에 분석 결과 저장/조회.

- save_analysis_result(allowed_tables, table_columns, relationships)
- get_latest_analysis_result() -> dict | None
"""
